 ...
 * Generated: 2026-07-12T02:01:58.490Z
 */

/**
 * precision theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { precisionTheme } from './precision';
...
export const precisionTheme = {
  ...
  tokens: {
    ...
    "--font-family-body": "var(--font-instrument-sans), \"Avenir Next\", \"Helvetica Neue\", sans-serif",
    "--font-family-heading": "var(--font-instrument-sans), \"Avenir Next\", \"Helvetica Neue\", sans-serif",
    "--font-family-code": "var(--font-ibm-plex-mono), \"SFMono-Regular\", Consolas, monospace",
    ...
    "--color-icon-secondary": "light-dark(#454652, #A9AAB9)",
    ...
    "--color-text-yellow": "light-dark(#584400, #FFE7A8)",
